...
- [x] `dotnet test WorkPilot.slnx` (with `WORKPILOTDB_CONNECTION` set) → Domain 85/85, Web 115/115, Api 107/107 (after the review fixes); `dotnet format --verify-no-changes` clean
